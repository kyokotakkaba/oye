...
<head>
	...
	<link rel="icon" type="image/png" sizes="114x114" href="<?=base_url("dist/images/favicons/apple-icon-114x114.png");?>">
	<link rel="icon" type="image/png" sizes="120x120" href="<?=base_url("dist/images/favicons/apple-icon-120x120.png");?>">
	<link rel="icon" type="image/png" sizes="144x144" href="<?=base_url("dist/images/favicons/apple-icon-144x144.png");?>">
	<link rel="icon" type="image/png" sizes="152x152" href="<?=base_url("dist/images/favicons/apple-icon-152x152.png");?>">
	<link rel="icon" type="image/png" sizes="180x180" href="<?=base_url("dist/images/favicons/apple-icon-180x180.png");?>">
	<link rel="icon" type="image/png" sizes="192x192" href="<?=base_url("dist/images/favicons/android-icon-192x192.png");?>">
